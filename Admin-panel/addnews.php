        ...
        <div class="container-fluid p-0 dashboard-section-custom">
            <div class="container">
                <div class="row py-4">
                    ...
                    <div class="col-md-10">
                        <h2 class="fw-bolder rounded-top-4 py-3 text-center">Add News</h2>
                        <form class="px-3 w-50 form-custom" action="#" method="POST">
                            <div class="first-name-form py-4">
                                <h5>News title</h5>
                                <input class="input-custom py-2 ps-3 w-100  border border-black" type="text" name="news_title" required>
                            </div>
                            <div class="py-4">
                                <h5>Description:</h5>
                                <textarea class="w-100" rows="10" name="description" required></textarea>
                            </div>
                            <div class="pb-4">
                                <h5>Expiry Date:</h5>
                                <input class="py-2 ps-3" type="date" name="news_date" required>
                            </div>
                            <div class="pb-4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input border border-black" type="radio" name="status" value="1" required>
                                    <label class="form-check-label" for="inlineRadio1">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input border border-black" type="radio" name="status" value="0" required>
                                    <label class="form-check-label" for="inlineRadio2">Deactivate</label>
                                </div>
                            </div>
                            <div class="pb-5 text-center">
                                <input type="submit" value="Save" class="btn bg-primary text-white" name="save">
                            </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST['save'])) {
    ...
    if ($ntitle != "" && $ndescription != "" && $ndate != "" && $nstatus != "") {

        $query = "INSERT INTO addnews (news_title,news_des,news_date,news_status) VALUES('$ntitle','$ndescription','$ndate','$nstatus')";
